        ...
        <div class="mb-6 overflow-x-auto rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
            <table class="w-full min-w-[520px] text-sm">
                ...
                <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                    ...
                    @empty
                        <tr><td colspan="3" class="px-4 py-10 text-center text-zinc-400">Nada por vender. Los artículos no retirados o comprados directo aparecen aquí.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="overflow-x-auto rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
            <table class="w-full min-w-[520px] text-sm">
                ...
                <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                    ...
                    @empty
                        <tr><td colspan="4" class="px-4 py-10 text-center text-zinc-400">Aún no hay ventas</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
