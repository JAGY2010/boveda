<x-layouts::app :title="'Contabilidad'">
    <div class="mx-auto w-full max-w-6xl">
        <x-flash />

        <div class="mb-5">
            <h1 class="text-2xl font-semibold text-zinc-900 dark:text-white">Contabilidad</h1>
            <p class="text-sm text-zinc-500">El dinero del negocio, en tiempo real</p>
        </div>
